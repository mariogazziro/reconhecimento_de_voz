    ...
    xlabel( 'Tempo (s)' ); 
    ylabel( 'Amplitude' ); 
    title( 'Áudio de controle: poesia em lingua inglesa recitada pelo autor do trabalho'); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    xlabel( 'Tempo (s)' ); 
    ylabel( 'Amplitude' ); 
    title( 'Voz original de Jair Bolsonaro (youtube 21/09)'); 
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    xlabel( 'Tempo (s)' ); 
    ylabel( 'Amplitude' ); 
    title( 'Áudio de controle: poesia em lingua portuguesa recitada pelo autor do trabalho'); 
